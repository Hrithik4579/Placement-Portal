...
const App = () => {
  ...
  useEffect(() => {
    ...
    const fetchStudents = async () => {
      try {
        const response = await axios.get('http://localhost:8000/api/admin/fetchStudents');
  ...
  const saveChanges = async (id) => {
    try {
      const response = await axios.put(`http://localhost:8000/api/admin/makeChanges/${id}`, editedStudent);
  ...
  const deleteStudent = async (id) => {
    try {
      await axios.delete(`http://localhost:8000/api/admin/deleteStudent/${id}`);
